...
fun ConnectTabScreen(viewModel: MainViewModel) {
  ...
  val activeEndpoint =
    remember(isConnected, remoteAddress, setupResolvedEndpoint, manualResolvedEndpoint, inputMode, notSet) {
      when {
  ...
  Column(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
      Text(stringResource(R.string.connect_gateway_title), style = mobileTitle1, color = mobileText)
      Text(
        if (isConnected) stringResource(R.string.connect_gateway_active) else stringResource(R.string.connect_gateway_inactive),
        style = mobileCallout,
      ...
      Column {
        Row(
          ...
          Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
            Text(stringResource(R.string.connect_endpoint_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
        ...
        Row(
          ...
          Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
            Text(stringResource(R.string.connect_status_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
    ...
    if (isConnected) {
      ...
      Button(
        ...
        Text(stringResource(R.string.connect_disconnect_btn), style = mobileHeadline.copy(fontWeight = FontWeight.SemiBold))
      }
    } else {
      Button(
        onClick = {
          ...
          if (config == null) {
            validationText =
              if (inputMode == ConnectInputMode.SetupCode) {
                context.getString(R.string.connect_validation_setup_code)
              } else {
        ...
        Text(stringResource(R.string.connect_connect_btn), style = mobileHeadline.copy(fontWeight = FontWeight.Bold))
      }
    }
    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.connect_diag_last_error), style = mobileHeadline, color = mobileWarning)
          ...
          Button(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(stringResource(R.string.connect_diag_copy_report), style = mobileCallout.copy(fontWeight = FontWeight.Bold))
          }
        }
      }
    }
    ...
    Surface(
      ...
      Row(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
          Text(stringResource(R.string.connect_advanced_title), style = mobileHeadline, color = mobileText)
          Text(stringResource(R.string.connect_advanced_subtitle), style = mobileCaption1, color = mobileTextSecondary)
        }
        Icon(
          imageVector = if (advancedOpen) Icons.Default.ExpandLess else Icons.Default.ExpandMore,
          contentDescription = if (advancedOpen) stringResource(R.string.connect_advanced_collapse) else stringResource(R.string.connect_advanced_expand),
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          Text(stringResource(R.string.connect_method_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
          ...
          if (inputMode == ConnectInputMode.SetupCode) {
            ...
            OutlinedTextField(
              ...
              placeholder = { Text(stringResource(R.string.connect_placeholder_setup_code), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              minLines = 3,
              maxLines = 5,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
              QuickFillChip(
                label = stringResource(R.string.quickfill_android_emulator),
                onClick = {
              ...
              QuickFillChip(
                label = stringResource(R.string.quickfill_localhost),
                onClick = {
            ...
            Text(stringResource(R.string.connect_host_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
            ...
            Text(stringResource(R.string.connect_port_label), style = mobileCaption1.copy(fontWeight = FontWeight.SemiBold), color = mobileTextSecondary)
            OutlinedTextField(
            ...
            Row(
              ...
              Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                ...
                Text(stringResource(R.string.use_tls_subtitle), style = mobileCallout, color = mobileTextSecondary)
              }
              Switch(
            ...
            OutlinedTextField(
              ...
              placeholder = { Text(stringResource(R.string.placeholder_token), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              singleLine = true,
              keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Ascii),
              textStyle = mobileBody.copy(color = mobileText),
            ...
            OutlinedTextField(
              ...
              placeholder = { Text(stringResource(R.string.placeholder_password), style = mobileBody, color = mobileTextTertiary) },
              modifier = Modifier.fillMaxWidth(),
              singleLine = true,
              keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Ascii),
              textStyle = mobileBody.copy(color = mobileText),
