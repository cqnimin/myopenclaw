        ...
        item {
          Box(
            ...
            Column(
              ...
              Text(
                stringResource(R.string.voice_tap_mic_hint),
                style = mobileCallout,
    ...
    Column(
      ...
      Row(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.spacedBy(4.dp)) {
          ...
          Text(
            if (speakerEnabled) stringResource(R.string.voice_speaker_on) else stringResource(R.string.voice_speaker_muted),
        ...
        Box(
          ...
          Button(
            ...
            Icon(
              ...
              contentDescription = if (micEnabled) stringResource(R.string.voice_mic_off_cd) else stringResource(R.string.voice_mic_on_cd),
      ...
      val stateText =
        when {
          queueCount > 0 -> stringResource(R.string.voice_state_queued, queueCount)
          micIsSending -> stringResource(R.string.voice_state_sending)
          micCooldown -> stringResource(R.string.voice_state_cooldown)
          micEnabled -> stringResource(R.string.voice_state_listening)
          else -> stringResource(R.string.voice_state_mic_off)
        }
      val stateColor =
        when {
      ...
      if (!hasMicPermission) {
        ...
        Text(
          if (showRationale) {
            stringResource(R.string.voice_mic_rationale)
          } else {
            stringResource(R.string.voice_mic_blocked)
          },
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) stringResource(R.string.voice_role_you) else stringResource(R.string.voice_role_openclaw),
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text(stringResource(R.string.voice_thinking), style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
